...
# io
parser.add_argument('--dataset', default='anview', choices=['UCF101', 'Kinetics', 'HMDB51', 'anview'],
                    help="path to dataset")
parser.add_argument('--clip-length', default=16,
                    help="define the length of each input sample.")
parser.add_argument('--frame-interval', type=int, default=2,
                    help="define the sampling interval between frames.")
parser.add_argument('--task-name', type=str, default='../test/MFNet3D_Anview_Splis1_UCF101',
                    help="name of current task, leave it empty for using folder name")
parser.add_argument('--model-dir', type=str, default="./",
                    help="set logging file.")
parser.add_argument('--log-file', type=str, default="./eval-anview-split1-ucf101.log",
                    help="set logging file.")
# device
...
if __name__ == '__main__':
    ...
    val_loader = VideoIter(video_prefix=os.path.join(data_root, 'raw', 'data'),  # change this part accordingly
                           txt_list=os.path.join(data_root, 'raw', 'list_cvt', 'anview_split1_test.txt'),
