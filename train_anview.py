...
# ------------------------------------
# @Author  : ljf
# @Contact : ljf.jeffrey86@gmail.com
# @Time    : 2019-01-08
# @File    : train_anview.py
# @Project : PyTorch-MFNet
# @Software: PyCharm
# @Desc    : train for anview
# ------------------------------------
"""
import os
import json
...
# io
parser.add_argument('--dataset', default='anview', choices=['UCF101', 'HMDB51', 'Kinetics', 'anview'],
